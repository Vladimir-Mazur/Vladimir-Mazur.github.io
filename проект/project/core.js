window.onload = function () {
  ...
  $('.fee_category:not(.active)').hover(function () {
    $('.fee_category.active').removeClass('active');
  });
  $( ".fee_category:not(.active)").on( "mouseleave", function() {
    $('.fee_category:eq(1)').addClass('active');
  } );
